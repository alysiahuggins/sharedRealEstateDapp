...
var ReleaseGoldWrapper = /** @class */ (function (_super) {
    ...
    function ReleaseGoldWrapper() {
         ...
         */
        _this.revokeReleasing = (0, BaseWrapper_1.proxySend)(_this.kit, _this.contract.methods.revoke);
        /**
         ...
         * @return A CeloTransactionObject
         */
        _this.refundAndFinalize = (0, BaseWrapper_1.proxySend)(_this.kit, _this.contract.methods.refundAndFinalize);
        /**
         * Locks gold to be used for voting.
         * @param value The amount of gold to lock
         */
        _this.lockGold = (0, BaseWrapper_1.proxySend)(_this.kit, _this.contract.methods.lockGold, (0, BaseWrapper_1.tupleParser)(BaseWrapper_1.valueToString));
        _this.transfer = (0, BaseWrapper_1.proxySend)(_this.kit, _this.contract.methods.transfer, (0, BaseWrapper_1.tupleParser)(BaseWrapper_1.stringIdentity, BaseWrapper_1.valueToString));
        /**
         * Unlocks gold that becomes withdrawable after the unlocking period.
         * @param value The amount of gold to unlock
         */
        _this.unlockGold = (0, BaseWrapper_1.proxySend)(_this.kit, _this.contract.methods.unlockGold, (0, BaseWrapper_1.tupleParser)(BaseWrapper_1.valueToString));
        /**
         * Relocks gold that has been unlocked but not withdrawn.
         * @param index The index of the pending withdrawal to relock from.
         * @param value The value to relock from the specified pending withdrawal.
         */
        _this._relockGold = (0, BaseWrapper_1.proxySend)(_this.kit, _this.contract.methods.relockGold, (0, BaseWrapper_1.tupleParser)(BaseWrapper_1.valueToString, BaseWrapper_1.valueToString));
        /**
         ...
         */
        _this.withdrawLockedGold = (0, BaseWrapper_1.proxySend)(_this.kit, _this.contract.methods.withdrawLockedGold, (0, BaseWrapper_1.tupleParser)(BaseWrapper_1.valueToString));
        /**
         * Transfer released gold from the ReleaseGold instance back to beneficiary.
         * @param value The requested gold amount
         */
        _this.withdraw = (0, BaseWrapper_1.proxySend)(_this.kit, _this.contract.methods.withdraw, (0, BaseWrapper_1.tupleParser)(BaseWrapper_1.valueToString));
        /**
         ...
         */
        _this.setAccount = (0, BaseWrapper_1.proxySend)(_this.kit, _this.contract.methods.setAccount);
        /**
         * Sets the name for the account
         * @param name The name to set
         */
        _this.setAccountName = (0, BaseWrapper_1.proxySend)(_this.kit, _this.contract.methods.setAccountName);
        /**
         * Sets the metadataURL for the account
         * @param metadataURL The url to set
         */
        _this.setAccountMetadataURL = (0, BaseWrapper_1.proxySend)(_this.kit, _this.contract.methods.setAccountMetadataURL);
        /**
         * Sets the wallet address for the account
         * @param walletAddress The address to set
         */
        _this.setAccountWalletAddress = (0, BaseWrapper_1.proxySend)(_this.kit, _this.contract.methods.setAccountWalletAddress);
        /**
         ...
         */
        _this.setLiquidityProvision = (0, BaseWrapper_1.proxySend)(_this.kit, _this.contract.methods.setLiquidityProvision);
        /**
         * Sets the contract's `canExpire` field to `_canExpire`
         * @param _canExpire If the contract can expire `EXPIRATION_TIME` after the release schedule finishes.
         */
        _this.setCanExpire = (0, BaseWrapper_1.proxySend)(_this.kit, _this.contract.methods.setCanExpire);
        /**
         * Sets the contract's max distribution
         */
        _this.setMaxDistribution = (0, BaseWrapper_1.proxySend)(_this.kit, _this.contract.methods.setMaxDistribution);
        /**
         * Sets the contract's beneficiary
         */
        _this.setBeneficiary = (0, BaseWrapper_1.proxySend)(_this.kit, _this.contract.methods.setBeneficiary);
        /**
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 3:
                        ...
                        return [2 /*return*/, (0, connect_1.toTransactionObject)(this.kit.connection, this.contract.methods.revokePending(group, value.toFixed(), lesser, greater, index))];
                }
            });
        });
    };
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 3:
                        _a = _b.sent(), lesser = _a.lesser, greater = _a.greater;
                        return [2 /*return*/, (0, connect_1.toTransactionObject)(this.kit.connection, this.contract.methods.revokeActive(group, value.toFixed(), lesser, greater, index))];
                }
            });
        });
    };
